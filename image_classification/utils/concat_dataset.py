...
if __name__ == '__main__':
    height = None
    width = None
    # test_image_id_list = ["1.jpg", "12.jpg", "3.jpg", "4.jpg", "5.jpg", "6.jpg", "7.jpg", "8.jpg", "9.jpg", "10.jpg"]
    ...
    train_loader = getDataLoader(dataset=train_data, batch_size=test_batch_size, shuffle=False, num_workers=num_workers,
    ...
    for epoch in range(epoch_num):
        for step, (batch_image, batch_label) in enumerate(train_loader):
            if batch_image is None and batch_label is None:
                ...
                continue
            img = batch_image[0]
            img = img.numpy()  # image=np.array(image)
