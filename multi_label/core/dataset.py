...
class TorchDataset(Dataset):
    ...
    def read_file(self, filename):
        image_label_list = file_processing.read_data(filename,split=",",convertNum=True)
...
if __name__=='__main__':
    ...
    train_filename="../image_scene_data/data.txt"
    image_dir='../image_scene_data/original'
