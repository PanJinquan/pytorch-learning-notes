...
image_dir='E:/git/PCwall/20190513/dataset'
label_dir='E:/git/PCwall/20190513/labels'

train_filename = 'E:/git/PCwall/20190513/train.txt' #训练文件
val_filename = 'E:/git/PCwall/20190513/val.txt'     #测试文件
num_classes = 2                            #包含BACKGROUND的label个数
dataset_type = 'voc'
...
if __name__ == '__main__':
    ...
    train_dataset = my_voc_dataset.Dataset(train_filename, image_dir,label_dir,transform=train_transform, target_transform=target_transform)
    ...
    val_dataset = my_voc_dataset.Dataset(val_filename, image_dir,label_dir,transform=test_transform,target_transform=target_transform)
