...
from vision.datasets import voc_dataset2
...
##
'''train.txt的格式：
[1].将图片放在JPEGImages目录下，将label文件放在labels文件夹下
[2].JPEGImages文件夹和labels文件夹必须在同一级目录，程序是根据图片的路径，查找labels文件夹下对应的标签
E:\git\VOC0712_dataset/VOCdevkit/VOC2007/JPEGImages/000012.jpg
E:\git\VOC0712_dataset/VOCdevkit/VOC2007/JPEGImages/000017.jpg
E:\git\VOC0712_dataset/VOCdevkit/VOC2007/JPEGImages/000023.jpg
'''
...
if __name__ == '__main__':
    ...
    train_dataset = voc_dataset2.Dataset(train_filename, transform=train_transform, target_transform=target_transform)
    ...
    val_dataset = voc_dataset2.Dataset(val_filename, transform=test_transform,target_transform=target_transform)
