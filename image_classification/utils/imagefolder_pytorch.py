...
from utils import image_processing, file_processing, imagefolder_dataset
import torch
import random
...
if __name__ == '__main__':
    ...
    train_transform = custom_transform("scale20_50", input_size, RGB_MEAN=[0.5, 0.5, 0.5], RGB_STD=[0.5, 0.5, 0.5])
    PIN_MEMORY = True
    NUM_WORKERS = 2
    DROP_LAST = True
